...
def analyzePcap(pcap, pcap_statistics):
	...
	for packet in packets:
		...
		if packet.haslayer("IP"):
			...
			pkt_len = len(packet)   ## len(pkt) can get full packet length (include ether layer)
...
if __name__ == "__main__":
    analyzePcap("./pkts/head1000-paded.pcap", pcap_statistics)
    ...
    resultWriter(pcap_statistics, "result.txt")
